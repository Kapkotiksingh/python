...
#my API Key: 3dc7a5bfb8d2dc3b3e75dbe1724f80a8
...
#creating the simple frontpage design
w=Tk()
w.geometry('800x400')
...
try:
#Mechenism for the weather data gathering from the website using requests and using through api key
     ...
     def label(a):          
          ...
          result=w_data
          #using exception handeling for some error
          try:
